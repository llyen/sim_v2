...
--
-- Host: 127.0.0.1
-- Czas wygenerowania: 20 Lis 2012, 21:53
...
('admin', 'deleteCounter'),
('admin', 'deleteCounterReading'),
('admin', 'deleteInvoice'),
('admin', 'deleteInvoiceData'),
('admin', 'deleteMedium'),
('admin', 'deleteObject'),
...
ALTER TABLE `invoices_data`
  ADD CONSTRAINT `invoices_data_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE NO ACTION,
